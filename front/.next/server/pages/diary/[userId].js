...
})(["width:100%;height:40px;background-color:", ";border-radius:10px;border-color:#4e4e4f;color:white;"], ({
  theme
...
})(["margin-top:10px;background-color:", ";border-color:#4e4e4f;color:white;border-radius:10px;"], ({
  theme
}) => theme.color.DARK_GRAY);
