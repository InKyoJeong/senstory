...
})(["border-radius:10px;margin-top:5px;color:white;border-color:", ";background-color:", ";font-size:16px;"], ({
  theme
...
const TestButton = external_styled_components_default()(external_antd_.Button).withConfig({
  displayName: "styles__TestButton",
  componentId: "sc-18zkv9z-3"
})(["background-color:", ";color:white;margin-top:15px;display:flex;align-items:center;justify-content:center;width:100%;border:none;border-radius:10px;height:40px;&:hover{background-color:#779bbf;color:white;}"], ({
  theme
}) => theme.color.INVALID);
// EXTERNAL MODULE: ./components/user/FormButton/index.tsx + 1 modules
var FormButton = __webpack_require__(5026);
...
const LoginForm = () => {
  ...
  const onChangeEmail = (0,external_react_.useCallback)(e => {
  ...
  const onClickTest = (0,external_react_.useCallback)(() => {
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(FormWrapper, {
    ...
    }), /*#__PURE__*/jsx_runtime_.jsx(FormButton/* default */.Z, {
      buttonText: "\uB85C\uADF8\uC778",
      loading: logInLoading
    }), /*#__PURE__*/jsx_runtime_.jsx(TestButton, {
      onClick: onClickTest,
      type: "default",
      htmlType: "submit",
      children: "\uD14C\uC2A4\uD2B8 \uACC4\uC815\uC73C\uB85C \uB85C\uADF8\uC778"
    })]
  });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [61,51,790,620,983], () => (__webpack_exec__(9124)));
