...
})(["background-color:", ";border-color:gray;color:white;border-radius:10px;overflow:hidden;"], ({
  theme
...
})(["margin-bottom:20px;margin-top:20px;& label{color:white;}& div{display:flex;margin-top:5px;}& select{flex:1;background-color:", ";border-radius:10px;color:white;&:focus{outline:none;}}"], ({
  theme
}) => theme.color.MIDDLE_GRAY);
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx(next_link.default, {
              ...
              children: /*#__PURE__*/jsx_runtime_.jsx("a", {
                children: item.avatar ? /*#__PURE__*/jsx_runtime_.jsx(external_antd_.Avatar, {
                  src: `${config/* backUrl */.T}/${item.avatar}`
