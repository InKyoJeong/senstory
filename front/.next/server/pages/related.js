...
/* harmony import */ var react_intersection_observer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2889);
...
/* harmony import */ var _reducers_user_loadMe__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1130);
/* harmony import */ var _reducers_user_randomUser__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(8947);
/* harmony import */ var _reducers_post_loadRelatedPost__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(7023);
...
/* harmony import */ var _components_common_Loader__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2620);
/* harmony import */ var _hocs_Conditional__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1986);
...
const Related = () => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (inView && hasMorePosts && !loadRelatedPostsLoading) {
      ...
      dispatch((0,_reducers_post_loadRelatedPost__WEBPACK_IMPORTED_MODULE_12__/* .loadRelatedPostRequest */ .PJ)(lastId));
    }
  ...
  if (!me) {
    return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx(_components_common_Loader__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z, {
      text: "\uB85C\uADF8\uC778 \uD398\uC774\uC9C0\uB85C \uC774\uB3D9\uC911..."
    });
  }

  const emptyStyle = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => ({
    color: 'white',
    display: 'flex',
    justifyContent: 'center',
    marginTop: '50%'
  }), []);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(_components_common_Layout__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z, {
    related: true,
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx(_hocs_Conditional__WEBPACK_IMPORTED_MODULE_10__/* .default */ .Z, {
      condition: mainPosts.length === 0,
      children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx("div", {
        style: emptyStyle,
        children: "\uD45C\uC2DC\uD560 \uAC8C\uC2DC\uBB3C\uC774 \uC5C6\uC2B5\uB2C8\uB2E4."
      })
    }), mainPosts.map(post => /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx(_components_post_PostCard__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z, {
      post: post,
...
const getServerSideProps = _store_configureStore__WEBPACK_IMPORTED_MODULE_5__/* .default.getServerSideProps */ .Z.getServerSideProps(store => async ({
  ...
  store.dispatch((0,_reducers_user_loadMe__WEBPACK_IMPORTED_MODULE_13__/* .loadMeRequest */ .a4)());
  store.dispatch((0,_reducers_post_loadRelatedPost__WEBPACK_IMPORTED_MODULE_12__/* .loadRelatedPostRequest */ .PJ)());
  store.dispatch((0,_reducers_user_randomUser__WEBPACK_IMPORTED_MODULE_14__/* .randomUserRequest */ .hL)());
...
var __webpack_exports__ = __webpack_require__.X(0, [61,51,790,620,442,53], () => (__webpack_exec__(9103)));
